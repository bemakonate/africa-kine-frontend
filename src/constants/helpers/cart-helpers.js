...
export const getPopulatedServerCart = async ({ cart, pickUpTime }) => {
    const { data } = await axios.post('http://localhost:1337/restaurant-settings/orders/validate-cart', { cart, pickUpTime });
    return data;
}
